...
import { MaterialUnit, copyMaterial, CatalogService, CatalogMaterial } from "app/shared/catalog.service";
...
export class MaterialViewComponent implements OnDestroy {
