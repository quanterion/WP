...
function download (url, name, opts) {
  ...
  xhr.onload = function () {
    saveAsDialog(xhr.response, name, opts)
  }
...
export let saveAsDialog = typeof window !== 'object' ? undefined : 'download' in HTMLAnchorElement.prototype
...
: function saveAs (blob, name, opts, popup?) {
  ...
  let isSafari = (window as any).safari
