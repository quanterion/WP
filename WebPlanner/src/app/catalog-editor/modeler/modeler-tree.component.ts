...
@Component({
  selector: 'app-modeler-tree',
  templateUrl: './modeler-tree.component.html',
  styleUrls: ['./modeler-tree.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ModelerTreeComponent implements OnInit, OnDestroy {
  ngOnDestroy(): void {
    this.stop$.next();
    this.stop$.complete();
  }
